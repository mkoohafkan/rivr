...
%\VignetteIndexEntry{technical-vignette} 
...
[id]: http://www.springer.com/us/book/9780387301747 "Chaudhry, M. H. (2007). Open-channel flow. Springer Science & Business Media."
...
$$
and $\frac{dA}{dy}$ and $\frac{dS_f}{dy}$ are as defined previously. Once the 
...
new intermediate values in the corrector step, and these predictions are 
...
results. On the predictor step, new values for $Q$ and $A$ are computed as 
$$
...
method for the downstream boundary is analogous, noting that the signs of the 
